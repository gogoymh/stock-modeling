...
from architecture4 import HB_transformer as net
...
model = net((5,3062), device, repeat=4, share=3, d_models=32, dropout=0)
model.to(device)
...
swa_model.to(device)
swa_start = 180
swa_scheduler = SWALR(optimizer, swa_lr=5e-3)
