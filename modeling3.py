...
from Dataset import Threeday_3
...
#input_path = "/data/ymh/s_modeling/data/input_v3"
input_path = "/home/DATA/ymh/s_modeling/data/input_v3"

dataset = Threeday_3(input_path)

train_sampler = SubsetRandomSampler(cfg.train_s3_idx)
valid_sampler = SubsetRandomSampler(cfg.valid_s3_idx)
n_val_sample = len(cfg.valid_s3_idx)
print(n_val_sample)
