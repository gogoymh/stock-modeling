...
for i in tqdm(range(len_stocks)):
    ...
    for j in range(start, (len(df)-5)):
        ...
        if df.iloc[(j+1),0] == 0:
            ...
            if profit_1 >= 5:
                buy = 1
            elif stop_1 >= -3 and profit_2 >= 5:
                buy = 1
            elif stop_12 >= -3 and profit_3 >= 5:
                buy = 1
            elif stop_123 >= -3 and profit_4 >= 5:
                buy = 1    
            elif stop_1234 >= -3 and profit_5 >= 5:
                buy = 1
            else:
                buy = 0
...
'''
        ...
        name = os.path.join("/home/DATA/ymh/s_modeling/data/input_v7","input_%08d_%d_%f_%f_" % (cnt, buy, profit, stop))
