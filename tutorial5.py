    ...
    if start > 0:
        ...
        for j in range(before, start):
            ...
            if ema_start == 0:
                ...
                ema_Open = 0.1*Open + 0.9*ema_Open
                ema_High = 0.1*High + 0.9*ema_High
                ema_Low = 0.1*Low + 0.9*ema_Low
                ema_Close = 0.1*Close + 0.9*ema_Close
                ema_Volume = 0.1*Volume + 0.9*ema_Volume
